"""
3D interpolation routine and supporting functions, taken from TensorFlow Graphics (tfg).
https://github.com/tensorflow/graphics/blob/master/tensorflow_graphics/math/interpolation/trilinear.py#L26-L93
"""
